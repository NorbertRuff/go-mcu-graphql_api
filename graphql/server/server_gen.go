...
var sources = []*ast.Source{
	&ast.Source{Name: "graphql/schemas/inputType.graphql", Input: `input NewLink {
    title: String!
    address: String!
    user_id: String
}
...
input Login {
	...
	&ast.Source{Name: "graphql/schemas/link.graphql", Input: `type Link {
    link_id: ID!
    title: String!
    address: String!
    user: User!
...
`, BuiltIn: false},
	&ast.Source{Name: "graphql/schemas/movie.graphql", Input: `type Movie {
    movie_id: ID!
    title: String!
    release_date: String!
    box_office: String!
...
`, BuiltIn: false},
	&ast.Source{Name: "graphql/schemas/mutation.graphql", Input: `type Mutation {
...
`, BuiltIn: false},
	&ast.Source{Name: "graphql/schemas/query.graphql", Input: `type Query {
    links: [Link!]!
    movies: [Movie!]!
    user: [User!]!
    tvShows: [TvShow!]!
}`, BuiltIn: false},
	&ast.Source{Name: "graphql/schemas/tvshow.graphql", Input: `type TvShow {
    show_id: ID!
    title: String!
    release_date: String!
    last_aired_date: String!
...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.User)
	fc.Result = res
	return ec.marshalNUser2ᚕᚖgithubᚗcomᚋnorbertruffᚋgoᚑgraphqlᚋgraphqlᚋmodelᚐUserᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNUser2ᚕᚖgithubᚗcomᚋnorbertruffᚋgoᚑgraphqlᚋgraphqlᚋmodelᚐUserᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.User) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNUser2ᚖgithubᚗcomᚋnorbertruffᚋgoᚑgraphqlᚋgraphqlᚋmodelᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
